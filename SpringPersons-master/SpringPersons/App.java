...
import be.intecbrussel.springpersons.dao.PersonDaoImpl;
...
//        Updating the second person and printing the new list of persons
        ...
        personDaoImpl.updatePerson(2, personToUpdate);
        System.out.println("\nAll persons listed after this update:");
        personDaoImpl.readAllPersons().stream()
                .map(Person::toString)
                .forEach(System.out::println);

//        Deleting the second person and printing the new list of persons
        personDaoImpl.deletePerson(person2);
        System.out.println("\nAll persons listed after this delete:");
        personDaoImpl.readAllPersons().stream()
                .map(Person::toString)
                .forEach(System.out::println);
...
//        Using Spring creating a new List
//        Spring Application Context
        ...
        System.out.println("\n\nSecond person in the list is  " + personService.getPerson(2).toString());
